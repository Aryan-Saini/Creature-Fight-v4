...
{
    /**
     * Ivysaur is the constructor for ivysaur type Objects
     * 
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if( enemyType.equalsIgnoreCase("Electric") == true){
                ...
                enemy.getHealthBar().add( -60/2 );
                playerWorld.showText("not very effect", playerWorld.getWidth()/2, playerWorld.getHeight()/2+26);
                Greenfoot.delay(30);
            }
            else if( enemyType.equalsIgnoreCase("Water") == true){
                enemy.getHealthBar().add( -60*2 );
