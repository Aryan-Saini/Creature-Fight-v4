...
public class Pikachu extends Creature
{
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if( enemyType.equalsIgnoreCase("Rock") == true){
                 ...
                 */
                playerWorld.showText("There no effect", playerWorld.getWidth()/2, playerWorld.getHeight()/2+26);

                //TODO (113): Delay the scenario by 30 pixels
                Greenfoot.delay(30);
            }
            //TODO (114): Otherwise, if the enemy type equals (ignoring case) Grass...
            else if( enemyType.equalsIgnoreCase("Grass") == true){
                 ...
                 *          and a y location of half the height of the world plus 26 pixels
                 */
                playerWorld.showText("It's not very effective", playerWorld.getWidth()/2, playerWorld.getHeight()/2+26);
